                ...
                <div class="card-body">
                    <form action="{{ route('kantins.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan nama kantin" required>
                        </div>

                        <div class="mb-3">
                            <label for="lokasi" class="form-label">Lokasi</label>
                            <input type="text" name="lokasi" id="lokasi" class="form-control" placeholder="Masukkan lokasi kantin" required>
                        </div>
